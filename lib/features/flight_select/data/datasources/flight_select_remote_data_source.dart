...
part 'flight_select_remote_data_source.g.dart';

/// Remote data source for flight select
@riverpod
class FlightSelectRemoteDataSource extends _$FlightSelectRemoteDataSource {
  @override
  Future<domain.FlightSelectState> build() async {
    throw UnimplementedError('This provider should not be used directly');
  }

  /// Get flight select data from the API
  Future<domain.FlightSelectState> getFlightSelectData({
    ...
    try {
      ...
      throw Exception('Failed to get flight select data: $e');
    }
  }
