...
class FirebaseService {
  ...
  static Future<String> generateFlightMessage({
    required String username,
    required String language,
    String? customTemplate,
  }) async {
    try {
      developer.log('FirebaseService: Generating message for language: $language', name: 'VoloAI');
      ...
      switch (language) {
        ...
        default:
          developer.log('FirebaseService: Using default template for language: $language', name: 'VoloAI');
          return baseTemplate;
      }
    } catch (e) {
      developer.log('FirebaseService: Error generating AI message: $e', name: 'VoloAI');
